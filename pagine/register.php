            ...
            if(strtolower($citta) == "genova")
            {
                ...
                if($cap >= 16121 && $cap <= 16167 || $cap == 16338)
                {
                    ...
                    else
                    {
                        ...
                        $nCarta = $_POST['nCarta'];
                        $dataScadenza = $_POST['scadenza']."-01";
...
<html>
                    ...
                    <div class="card" style="border-radius: 1rem; max-width:900px;">
                        <div class="card-body p-4 p-lg-5 text-black formRegister center">
                            <form method="post" action="">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 pb-2">
                                        <input type="text" class="form-control" pattern="[0-9]+" name="nCarta" placeholder="Numero cartaCredito" maxlength="16" required>
                                      </div>
                                    <div class="form-group col-md-4 pb-2">
    ...
    <!--Modal cap sbagliato-->
    <div class="modal fade" id="cap" tabindex="-1" aria-labelledby="capLabel" aria-hidden="true" style="color:black;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="capLabel">Attenzione!</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Questo numero è già stato utilizzato!
